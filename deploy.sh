...
kubectl set image deployments/client-deployment client=samjbro/multi-k8s-client:$SHA
kubectl set image deployments/worker-deployment worker=samjbro/multi-k8s-worker:$SHA